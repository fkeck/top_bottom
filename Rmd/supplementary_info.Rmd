...
ins_fig()
```
Proportion of (*A*) natural, (*B*) agricultural and (*C*) artificial surfaces in watersheds of high- ($> 1400$ m) and low-altitude ($\leq 1400$ m) lakes. The landcover analysis was conducted on a subset of 39 lakes for which data were available (10 high altitude lakes and 29 low altitude lakes). (*D*) Total human population living within a radius of 20 km of high-altitude lakes (n = 17) and low-altitude lakes (n = 31). Boxplots depict medians, first and third quartiles, and full ranges (bounded at 1.5 × interquartile range). 
