...
\pagebreak
\addcontentsline{toc}{subsection}{Supplementary Information Figures}
...
ins_fig()
```
Map of the 48 lakes included in the study.
...
\pagebreak
\addcontentsline{toc}{subsection}{Supplementary Information Tables}
```{r, message = FALSE}
...
kableExtra::kable(lakes_datation, "latex", digits = 2, booktabs = TRUE, linesep = "",
                  escape = FALSE, align = "rlccrrrrrrrc",
                  col.names = linebreak(colnames(lakes_datation), align = "c")) %>% 
  kable_styling(latex_options = c("scale_down"))
```
\begin{footnotesize}
\textsuperscript{a}Additional source: Giguet-Covex et al. ;\\
\textsuperscript{b}Additional source: Alric et al.;\\
\textsuperscript{c}Additional source: Belle et al.;\\
\textsuperscript{d}Previous studies of Sarazin et al. and Lavrieux et al. indicated a mean sedimentation rate of 0.46 and 0.52 over the last century. Furthermore, two floods events dated at 1907 and 1846 by Lavrieux et al. has been identified along the 2015 core from XrF logging  at 57.5 and 75.5 cm, respectively.\\
\textsuperscript{e}Nedjai et al. indicated a mean sedimentation rate of 0.21 cm/yr over the last century.\\
...
ins_tab()
```
Data supporting the dating and sampling of sediment cores. For each lakes is reported: the year of coring, the availability of Xrf, ^14^C and radionuclides data, the depth (cm) for 1986 and 1963 ^137^Cs fallouts and lead increase/decrease, the depth (cm) for top and bottom samples. NC stands for "not clear". Methods used to determine the depth of top and bottom samples are indicated in the last column where numbers refer to methods described in Supplementary Information Methods 2.
...
\pagebreak
\addcontentsline{toc}{subsection}{Supplementary Information Data}
##### Dataset 1 (separate CSV file)
Complete list of OTUs used in the analyses with their representative DNA sequence, their taxonomic classification and their trophic classification. 
